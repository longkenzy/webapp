...
import { X, User, Rocket, FileText, Calendar, Settings, CheckCircle, RefreshCw, Building2, AlertCircle, Star, Save } from 'lucide-react';
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-lg font-bold text-white" style={{ fontFamily: "'Segoe UI', Tahoma, Geneva, Verdana, sans-serif" }}>
                  {editData ? 'Chỉnh sửa Case Triển Khai (Admin)' : 'Tạo Case Triển Khai (Admin)'}
                </h2>
                <p className="text-blue-50 text-xs mt-0.5">Quản lý triển khai sản phẩm/dịch vụ</p>
              </div>
            </div>
            <button
              type="button"
