...
export default function AdminWarrantyWorkPage() {
  ...
  }).sort((a, b) => new Date(b.startDate).getTime() - new Date(a.startDate).getTime()), [warranties, searchTerm, selectedHandler, selectedStatus, selectedWarrantyType, selectedCustomer, dateFrom, dateTo]);
