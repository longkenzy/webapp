                ...
                <div className="bg-white rounded border border-gray-200">
                  ...
                  <div className="p-3">
                    <select
                      ...
                      className={`w-full px-2.5 py-2 text-sm border rounded focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors ${errors.handler ? 'border-red-300 bg-red-50' : 'border-gray-300'
                        }`}
                    >
                    ...
                    <div className="relative" ref={dropdownRef}>
                      <div className="relative">
                        ...
                        <input
                          ...
                          className={`w-full pl-9 pr-9 py-2 text-sm border rounded focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all ${errors.supplierId ? 'border-red-300 bg-red-50' : 'border-gray-300'
                            }`}
