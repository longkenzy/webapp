...
export default function DeliveryCaseTable({ 
  ...
  return (
    <div className="bg-white rounded-md shadow">
          ...
          <div className="flex items-center gap-2 md:gap-3">
            {statusFilter && (
              <div className="flex items-center gap-1 md:gap-2">
                ...
                <span className="px-1.5 md:px-2 py-0.5 md:py-1 bg-green-100 text-green-800 rounded text-[10px] md:text-xs font-medium">
      ...
      <div className="hidden md:block px-6 py-4 bg-gradient-to-r from-green-50 to-emerald-50 border-b border-gray-200">
          ...
          return (
            ...
            >
              ...
              <div className="mb-2">
                ...
                {caseItem.customer?.fullCompanyName && (
              ...
              {caseItem.products && caseItem.products.length > 0 && (
                <div className="mb-2 space-y-1">
                  {caseItem.products.map((product) => (
                    <div key={product.id} className="text-[10px] text-gray-700 border-l-2 border-green-300 pl-2">
              ...
              <div className="grid grid-cols-2 gap-2 mb-2 text-[10px]">
                ...
                <div>
                  ...
                  <div className="font-medium text-gray-900 break-words">
                    {caseItem.customer?.shortName || 'N/A'}
                  </div>
                </div>
              </div>
