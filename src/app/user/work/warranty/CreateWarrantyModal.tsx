...
import { X, User, Shield, FileText, Calendar, Settings, CheckCircle, RefreshCw, Building2, Star } from 'lucide-react';
        ...
        <div className="ios-input-fix bg-white rounded shadow-2xl w-full max-w-5xl max-h-[90vh] overflow-hidden flex flex-col">
         ...
         <div className="bg-gradient-to-r from-emerald-600 to-teal-600 px-5 py-4 flex items-center justify-between flex-shrink-0">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-lg font-bold text-white" style={{ fontFamily: "'Segoe UI', Tahoma, Geneva, Verdana, sans-serif" }}>Tạo Case Bảo Hành</h2>
                <p className="text-emerald-50 text-xs mt-0.5">Quản lý bảo hành sản phẩm/dịch vụ</p>
              </div>
            </div>
            <button
              type="button"
