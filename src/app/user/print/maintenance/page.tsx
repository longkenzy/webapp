...
export default function MaintenancePrintPage() {
  ...
  const handleGenerateDocument = async () => {
    if (!selectedPartner || !currentUser || !maintenanceDate || !partnerAddress) {
    ...
    try {
      const data = {
        ...
        maintenanceCompanyName: 'CÔNG TY TNHH CÔNG NGHỆ - DỊCH VỤ SMART SERVICES',
        maintenanceCompanyAddress: 'Tòa nhà MIOS, 121 Hoàng Hoa Thám, Phường Gia Định, TP. Hồ Chí Minh',
        maintenancePersonName: currentUser.employee?.fullName || currentUser.name || '',
        maintenancePersonPosition: currentUser.employee?.position || currentUser.department || '',
        maintenancePersonPhone: currentUser.employee?.primaryPhone || currentUser.phone || '',
        
        // Maintenance details
        formattedDate: new Date(maintenanceDate).toLocaleDateString('vi-VN', {
          day: '2-digit',
          month: '2-digit',
          year: 'numeric',
      ...
      const response = await fetch('/api/print/maintenance', {
        method: 'POST',
        headers: {
      ...
      if (response.ok) {
        ...
        a.href = url;
        a.download = `bien-ban-bao-tri-${new Date().toISOString().split('T')[0]}.docx`;
      ...
      <div className="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-6">
          ...
          <div className="flex items-center mb-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Tạo biên bản bảo trì</h1>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
          <div className="p-4 border-b border-gray-200 bg-gradient-to-r from-blue-50 to-indigo-50">
            <h2 className="text-lg font-semibold text-gray-900 flex items-center">
              ...
              Thông tin biên bản bảo trì
            </h2>
          </div>
          
          <div className="p-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              {/* Chọn công ty cần bảo trì */}
            ...
            <div className="mt-4 flex justify-center">
              <button
                ...
                disabled={isLoading}
                className="inline-flex items-center px-5 py-2.5 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-medium rounded-md hover:from-blue-700 hover:to-indigo-700 focus:ring-1 focus:ring-blue-300 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 shadow-sm hover:shadow-md text-sm"
              >
                {isLoading ? (
                  <>
