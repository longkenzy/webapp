          ...
          <div className="sticky top-0 bg-gradient-to-r from-green-600 to-emerald-600 text-white px-4 md:px-6 py-3 md:py-4 rounded-t-2xl md:rounded-t-lg z-40 flex-shrink-0">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2 md:gap-3">
                ...
                <div>
                  <h2 className="text-base md:text-lg font-semibold">Tạo Case Giao Hàng</h2>
                  <p className="text-green-100 text-xs md:text-sm hidden sm:block">Hệ thống quản lý giao hàng</p>
                </div>
              </div>
              <button type="button" onClick={handleClose} className="p-1.5 md:p-2 text-white/80 hover:text-white hover:bg-white/20 rounded-md transition-colors">
                <X className="h-5 w-5" />
              </button>
            </div>
          </div>
