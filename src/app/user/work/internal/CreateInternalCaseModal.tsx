  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        alert('Tạo case nội bộ thành công!');
        ...
        alert(`Lỗi: ${error.error || 'Không thể tạo case'}`);
      }
    } catch (error) {
          ...
          <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-1">
                  <label className="text-xs font-medium text-gray-600 flex items-center">
                    <span className="w-24">Người yêu cầu</span>
                ...
                <div className="space-y-1">
                  <label className="text-xs font-medium text-gray-600 flex items-center">
                    <span className="w-24">Loại case</span>
                    <span className="text-red-500 ml-1">*</span>
                  </label>
                  <select
            ...
            <div className="bg-gray-50 rounded-md p-4 border border-gray-200">
              ...
              <div className="space-y-4">
                <div className="space-y-1">
                  <label className="text-xs font-medium text-gray-600 flex items-center">
                    <span className="w-24">Vụ việc</span>
                    <span className="text-red-500 ml-1">*</span>
                  </label>
                  <input
                    type="text"
            ...
            <div className="bg-gray-50 rounded-md p-4 border border-gray-200">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-1">
                  <label className="text-xs font-medium text-gray-600 flex items-center">
                    <span className="w-24">Kết thúc</span>
                  </label>
                  <input
                    type="datetime-local"
